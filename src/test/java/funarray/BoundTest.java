...
public class BoundTest {
  ...
  static final Expression A = new Expression(new Variable(new Interval(0, 0), "A"), InfInt.of(0));
  static final Expression B = new Expression(new Variable(new Interval(0, 0), "B"), InfInt.of(0));
