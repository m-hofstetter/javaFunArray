...
public record UnequalTo<
  ...
  public State<ElementT, VariableT> satisfy(State<ElementT, VariableT> state) {
    ...
    state = satisfyBoundOrder(state, left, right, State::satisfyExpressionUnequalToInBoundOrder);
    return state;
  }
  ...
  public State<ElementT, VariableT> satisfyComplement(State<ElementT, VariableT> state) {
    ...
    state = satisfyBoundOrder(state, right, left, State::satisfyExpressionEqualToInBoundOrder);
    return state;
  }
